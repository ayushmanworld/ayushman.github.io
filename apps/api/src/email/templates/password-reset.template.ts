...
<title>Reset Your Password — Ayushman</title></head>
...
<div style="max-width:600px;margin:0 auto;padding:40px 20px;">
  ...
  <div style="background:white;border-radius:16px;padding:40px;border:1px solid #DDD6C8;text-align:center;">
    ...
    <div style="background:#FBF0DC;border-radius:12px;padding:16px;text-align:left;margin-bottom:16px;">
      <p style="color:#4A3728;font-size:13px;margin:0;">
        🛡️ <strong>Security tip:</strong> If you did not request a password reset, your account may be at risk.
        Please <a href="mailto:security@ayushman.world" style="color:#C8782A;">contact us</a> immediately.
      </p>
    </div>
    <p style="color:#B8A898;font-size:11px;margin:0;">
      Or copy this URL: <span style="color:#2D7A6B;">${params.resetUrl}</span>
    </p>
  </div>
